...
USE(parameter2);
  ...
  if (block8.is_used()) {
    ...
    tmp15 = PromiseBuiltinsAssembler(state_).IsPromiseHookEnabledOrHasAsyncEventDelegate();
    ca_.Branch(tmp15, &block10, std::vector<Node*>{}, &block11, std::vector<Node*>{});
  }
  ...
  if (block10.is_used()) {
    ...
    tmp17 = CodeStubAssembler(state_).CallRuntime(Runtime::kPromiseHookInit, parameter0, tmp14, tmp16); 
    ca_.Goto(&block11);
  }
  ...
  if (block9.is_used()) {
    ...
    tmp18 = CodeStubAssembler(state_).IsDebugActive();
    ca_.Branch(tmp18, &block12, std::vector<Node*>{phi_bb9_5}, &block13, std::vector<Node*>{phi_bb9_5});
  }
  ...
  if (block12.is_used()) {
    ...
    tmp19 = CodeStubAssembler(state_).CallRuntime(Runtime::kDebugPushPromise, parameter0, phi_bb12_5); 
  ...
  if (block13.is_used()) {
    ...
    tmp20 = True_0(state_);
    std::tie(tmp21, tmp22) = CreatePromiseResolvingFunctions_0(state_, TNode<Context>{parameter0}, TNode<JSPromise>{phi_bb13_5}, TNode<Object>{tmp20}, TNode<NativeContext>{parameter0}).Flatten();
    ...
    tmp27 = CodeStubAssembler(state_).Call(TNode<Context>{parameter0}, TNode<Object>{tmp23}, TNode<Object>{tmp26}, TNode<Object>{tmp21}, TNode<Object>{tmp22});
    }
  ...
  if (block16.is_used()) {
    ...
    ca_.Goto(&block15, phi_bb16_5, tmp25);
  }

  TNode<JSPromise> phi_bb17_5;
  if (block17.is_used()) {
    ca_.Bind(&block17, &phi_bb17_5);
    ca_.Goto(&block15, phi_bb17_5, tmp29);
  }
  ...
  if (block15.is_used()) {
    ...
    tmp31 = CodeStubAssembler(state_).Call(TNode<Context>{parameter0}, TNode<Object>{tmp22}, TNode<Object>{tmp30}, TNode<Object>{phi_bb15_11});
  ...
  if (block14.is_used()) {
    ...
    ca_.Branch(tmp18, &block18, std::vector<Node*>{phi_bb14_5}, &block19, std::vector<Node*>{phi_bb14_5});
  }
