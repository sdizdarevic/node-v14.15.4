  ...
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_JS_RECEIVER_TYPE, 181) \
      ...
      V(FIRST_JS_OBJECT_TYPE, 182) \
        ...
        V(JS_COLLATOR_TYPE, 1064) \
        V(JS_CONTEXT_EXTENSION_OBJECT_TYPE, 1065) \
        V(JS_DATE_TYPE, 1066) \
        V(JS_DATE_TIME_FORMAT_TYPE, 1067) \
        V(JS_DISPLAY_NAMES_TYPE, 1068) \
        V(JS_ERROR_TYPE, 1069) \
        V(JS_FINALIZATION_REGISTRY_TYPE, 1070) \
