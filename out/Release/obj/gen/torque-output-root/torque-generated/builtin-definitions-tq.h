...
TFC(ThrowWasmTrapBrOnExnNullRef, ThrowWasmTrapBrOnExnNullRef) \
TFC(ThrowWasmTrapRethrowNullRef, ThrowWasmTrapRethrowNullRef) \
...
TFJ(AggregateErrorPrototypeErrorsGetter, 0, kReceiver) \
